...
def installed(){
    def functionCall1 status=currentStatus("random","random","random")
    def functionCall2=currentStatus("${tag}","random","random","random")
    def takeParams=[
...
private currentStatus(flag,devices,master,attribute){
    return flag
