...
def installed(){
    def functionCall1 capabilityCommands=getDeviceCapabilityCommands("random")
    def functionCall2=getDeviceCapabilityCommands("${switches}","random")
    def takeParams=[
...
def getDeviceCapabilityCommands(flag,deviceCapabilities){
    return flag
    def map=[:]
